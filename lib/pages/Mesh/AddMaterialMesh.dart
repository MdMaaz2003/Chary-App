...
class AddMaterialMesh extends StatefulWidget {
  const AddMaterialMesh({Key? key}) : super(key: key);

  @override
  _AddMaterialMeshState createState() => _AddMaterialMeshState();
}

class _AddMaterialMeshState extends State<AddMaterialMesh> {
      ...
      appBar: AppBar(
        ...
        leading: IconButton(
          ...
          onPressed: () => Navigator.pushAndRemoveUntil(
              context,
              MaterialPageRoute(
                builder: (_) => const ListScreenMeshAdmin(),
              ),
              (route) => false),
        ),
      ),
